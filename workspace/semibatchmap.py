...
for i, _ in enumerate(data):
    plot_colormap(fluxes, 1000.0/masses, data[i][0], r'$\mathrm{Da}^{-1}$', '$V_0/W_0$ (cm$^3$ g$^{-1}$)', data[i][-1], data[i][1]+'.png', xscale='log', yscale='log', zscale=data[i][2], zmin=data[i][3], zmax=data[i][4])
