...
compounds_v2 = {
        ...
        'C1'      : { 'MW':  16.043 , 'dHsol/R': +2.735977354 , 'lnH0': 8.731344842 },
        'C2'      : { 'MW':  30.070 , 'dHsol/R': -600.1989700 , 'lnH0': 8.778734219 },
        'C3'      : { 'MW':  44.097 , 'dHsol/R': -1090.128588 , 'lnH0': 8.719472698 },
        'C4'      : { 'MW':  58.124 , 'dHsol/R': -1818.230692 , 'lnH0': 9.421184710 },
        'C5'      : { 'MW':  72.151 , 'dHsol/R': -2209.744754 , 'lnH0': 9.760611249 },
        'C6'      : { 'MW':  86.178 , 'dHsol/R': -2805.190625 , 'lnH0': 10.09889626 },
        'C7'      : { 'MW': 100.205 , 'dHsol/R': -3282.775276 , 'lnH0': 10.41519594 },
        'C8'      : { 'MW': 114.232 , 'dHsol/R': -3728.364057 , 'lnH0': 10.85028070 },
        'N2'      : { 'MW':  28.014 , 'dHsol/R': +469.3227179 , 'lnH0': 8.037102165 },
        'CO2'     : { 'MW':  44.009 , 'dHsol/R': -1010.182899 , 'lnH0': 9.780597487 },
        'VinAce'  : { 'MW':  86.090 , 'dHsol/R': -2500.220269 , 'lnH0': 9.856908889 },
        'C2H4'    : { 'MW':  28.054 , 'dHsol/R': -626.6910178 , 'lnH0': 8.823736400 },
        'iC4'     : { 'MW':  58.124 , 'dHsol/R': -1627.016052 , 'lnH0': 9.258830151 },
        'Benzene' : { 'MW':  78.114 , 'dHsol/R': -2919.958665 , 'lnH0': 9.917574296 },
        'Toluene' : { 'MW':  92.141 , 'dHsol/R': -3461.185768 , 'lnH0': 10.40275611 },
        }
...
class Calculator():
    ...
    def __init__( self, temp=573.15, pressure=1.0, volume=1.0, mass=10.0, version=2 ):
        ...
        elif self.version == 'vse':
            self.names  = [ key for key in compounds_vse.keys() ]
            self.MW     = numpy.array([ value[ 'MW'      ] for value in compounds_vse.values() ])
            self.dHsolR = numpy.array([ value[ 'dHsol/R' ] for value in compounds_vse.values() ])
            self.lnH0   = numpy.array([ value[ 'lnH0'    ] for value in compounds_vse.values() ])
        else:
            self.names  = [ key for key in compounds_v2.keys() ]
