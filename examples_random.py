...
print('See lines 17-37 of \'examples_random.py\' script.')
...
print('we choose a random number n of species and generate n random numbers that add to a random number w < 1.')
print('Indeed, a lot of the melt should be long hydrocarbons (C20-C30) that do not vaporize.')
print('See lines 76-100 of \'examples_random.py\' script.')
...
n3 = numpy.random.randint(1, 12)
i3 = list(sorted( numpy.random.choice( list(range(11)), n3, replace=False ) ))
y3 = numpy.zeros(11)
...
n4 = numpy.random.randint(1, 12)
i4 = list(sorted( numpy.random.choice( list(range(11)), n4, replace=False ) ))
W2 = numpy.random.rand(1)
w4 = numpy.zeros(11)
...
print('T = {:g} K'.format(T))
print('P = {:g} atm'.format(P))
print('{:>5s} {:>10s} {:>10s} {:>10s}'.format('', 'Hv', 'y3', 'w3'))
print('-' * 38)
for ( Hi, ( name, value1 ), ( _, value2 ) ) in zip( calc.Hv, y3.items(), w3.items() ):
    print('{:>5s} {:10.1f} {:10f} {:10f}'.format( name, Hi, value1, value2 ))
print('-' * 38)
print('{:>5s} {:>10s} {:10f} {:10f}'.format( 'Total', '', sum(y3.values()), sum(w3.values()) ))
print()
print('Liquid-Phase Mass Fractions (w4) to Gas-Phase Mole Fractions (y4)')
print('T = {:g} K'.format(T))
print('P = {:g} atm (est.)'.format(P2))
print('{:>5s} {:>10s} {:>10s} {:>10s}'.format('', 'Hv', 'w4', 'y4'))
print('-' * 38)
for ( Hi, ( name, value1 ), ( _, value2 ) ) in zip( calc.Hv, w4.items(), y4.items() ):
    print('{:>5s} {:10.1f} {:10f} {:10f}'.format( name, Hi, value1, value2 ))
print('-' * 38)
print('{:>5s} {:>10s} {:10f} {:10f}'.format( 'Total', '', sum(w4.values()), sum(y4.values()) ))
print()
