...
print('See lines 30-39 of \'batch_random.py\' script.')
...
print('See lines 70-80 of \'batch_random.py\' script.')
...
print('Then, the code computes the nondimensional Henry\'s constants and the phase partition coefficients.')
print('See lines 112-126 of \'batch_random.py\' script.')
...
print('Then, the code normalizes them to the total number of monomer units.')
print('See lines 158-168 of \'batch_random.py\' script.')
...
print('See lines 202-224 of \'batch_random.py\' script.')
...
ax2.set_ylabel('Liquid-Phase Partition')
pyplot.tight_layout()
pyplot.savefig('batch_random_partition_logn.png')
pyplot.close()
...
ax2.set_ylabel('Liquid-Phase Partition')
pyplot.tight_layout()
pyplot.savefig('batch_random_partition_logn_compare.png')
pyplot.close()
...
print('Then, the code normalizes them to the total number of monomer units.')
print('For reference, we also solve the discrete equations.')
print('See lines 280-302 of \'batch_random.py\' script.')
...
ax2.set_ylabel('Liquid-Phase Partition')
pyplot.tight_layout()
pyplot.savefig('batch_random_nopartition_logn.png')
pyplot.close()
...
ax2.set_ylabel('Liquid-Phase Partition')
pyplot.tight_layout()
pyplot.savefig('batch_random_nopartition_logn_compare.png')
pyplot.close()
