...
print('imagine a headspace where the 16 species (H2 C1-C8 N2 CO2 VinAce C2H4 iC4 Benzene Toluene) have mole fractions of 1/16.')
print('For an example with liquid-phase mass fractions as the starting point,')
print('imagine a melt where each of the 16 species have a mass fraction of 0.01.')
...
print('See lines 22-31 of \'simple.py\' script.')
...
print('{:>10s} {:>10s} {:>10s} {:>10s} {:>10s}'.format('', 'Hv', 'MW', 'y1', 'w1'))
print('-' * 54)
...
print('-' * 54)
print('{:>10s} {:>10s} {:>10s} {:10f} {:10f}'.format( 'Total', '', '', numpy.sum(y1), numpy.sum(w1) ))
print()
print('Liquid-Phase Mass Fractions (w2) to Gas-Phase Mole Fractions (y2)')
print('T = {:g} K'.format(T))
print('P = {:g} atm (est.)'.format(P2))
print('{:>10s} {:>10s} {:>10s} {:>10s} {:>10s}'.format('', 'Hv', 'MW', 'w2', 'y2'))
print('-' * 54)
for ( name, Hi, Mi, value1, value2 ) in zip( calc.names, calc.Hv, calc.MW, w2, y2 ):
    print('{:>10s} {:10.1f} {:10.3f} {:10f} {:10f}'.format( name, Hi, Mi, value1, value2 ))
print('-' * 54)
print('{:>10s} {:>10s} {:>10s} {:10f} {:10f}'.format( 'Total', '', '', numpy.sum(w2), numpy.sum(y2) ))
print()
...
pyplot.tight_layout()
pyplot.savefig('simple_y1w1.png')
pyplot.close()
...
pyplot.tight_layout()
pyplot.savefig('simple_y2w2.png')
pyplot.close()
...
print('We normalize so that the mass fractions of the volatiles species in the liquid phase add to 0.16.')
print('See lines 99-112 of \'simple.py\' script.')
...
pyplot.title('Gas-Phase Mole Fractions to Liquid-Phase Mass Fractions')
pyplot.tight_layout()
pyplot.savefig('simple_y3w3.png')
pyplot.close()
...
pyplot.title('Liquid-Phase Mass Fractions to Gas-Phase Mole Fractions')
pyplot.tight_layout()
pyplot.savefig('simple_y4w4.png')
pyplot.close()
