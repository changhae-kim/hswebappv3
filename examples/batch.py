...
pyplot.tight_layout()
pyplot.savefig('batch_partition_discrete.png')
pyplot.close()
...
print('See lines 63-73 of \'batch.py\' script.')
...
ax2.set_ylabel('Liquid-Phase Partition')
pyplot.tight_layout()
pyplot.savefig('batch_nopartition_discrete.png')
pyplot.close()
...
print('Then, the code computes the nondimensional Henry\'s constants and the phase partition coefficients.')
print('See lines 105-120 of \'batch.py\' script.')
...
ax2.set_ylabel('Liquid-Phase Partition')
pyplot.tight_layout()
pyplot.savefig('batch_partition_continuum.png')
pyplot.close()
...
print('Then, the code normalizes them to the total number of monomer units.')
print('See lines 152-162 of \'batch.py\' script.')
...
ax2.set_ylabel('Liquid-Phase Partition')
pyplot.tight_layout()
pyplot.savefig('batch_nopartition_continuum.png')
pyplot.close()
...
print('See lines 196-220 of \'batch.py\' script.')
